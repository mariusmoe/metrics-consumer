...
public class BinaryComputingIterator implements Iterator<Double> {
	...
	public BinaryComputingIterator(final Iterator<Double> iterator1, final Iterator<Double> iterator2, final Double default1, final Double default2, final BinaryOperator<Double> operator) {
