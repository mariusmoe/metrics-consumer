...
public class DiffAdapterFactory extends AdapterFactoryImpl {
	...
	protected DiffSwitch<Adapter> modelSwitch =
		new DiffSwitch<Adapter>() {
			@Override
			public Adapter casePatchStringEdit(PatchStringEdit object) {
				return createPatchStringEditAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.moe.metricsconsumer.diff.PatchStringEdit <em>Patch String Edit</em>}'.
	 * <!-- begin-user-doc -->
