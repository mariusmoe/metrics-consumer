...
import com.moe.metricsconsumer.exercise.AbstractExercisePart;
...
import com.moe.metricsconsumer.exercise.AbstractTask;
import com.moe.metricsconsumer.exercise.Answer;
import com.moe.metricsconsumer.exercise.Exercise;
import com.moe.metricsconsumer.exercise.ExerciseProposals;
import com.moe.metricsconsumer.exercise.MarkerInfo;
import com.moe.metricsconsumer.exercise.ExercisePart;
import com.moe.metricsconsumer.exercise.ExercisePartProposals;
import com.moe.metricsconsumer.exercise.ExercisePartRef;
...
import com.moe.metricsconsumer.exercise.ReplaceSubstringEdit;
import com.moe.metricsconsumer.exercise.ExerciseFactory;
import com.moe.metricsconsumer.exercise.ExercisePackage;
import com.moe.metricsconsumer.exercise.StringEdit;
import com.moe.metricsconsumer.exercise.StringEditAnswer;
import com.moe.metricsconsumer.exercise.StringEditTaskProposal;
import com.moe.metricsconsumer.exercise.StringQuestion;
import com.moe.metricsconsumer.exercise.Task;
import com.moe.metricsconsumer.exercise.TaskAnswer;
import com.moe.metricsconsumer.exercise.TaskEvent;
import com.moe.metricsconsumer.exercise.TaskProposal;
import com.moe.metricsconsumer.exercise.TaskRef;
...
public class ExercisePackageImpl extends EPackageImpl implements ExercisePackage {
	 ...
	 * @see com.moe.metricsconsumer.exercise.ExercisePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		// Create annotations
		// com.moe.metricsconsumer.exercise.views.ExerciseView
		createNoAnnotations();
		// com.moe.metricsconsumer.exercise.MarkerInfo
		createNo_1Annotations();
	}

	/**
	 * Initializes the annotations for <b>com.moe.metricsconsumer.exercise.views.ExerciseView</b>.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void createNoAnnotations() {
		String source = "com.moe.metricsconsumer.exercise.views.ExerciseView";	
		addAnnotation
	...
	/**
	 * Initializes the annotations for <b>com.moe.metricsconsumer.exercise.MarkerInfo</b>.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void createNo_1Annotations() {
		String source = "com.moe.metricsconsumer.exercise.MarkerInfo";	
		addAnnotation
