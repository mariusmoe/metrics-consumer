...
import com.moe.metricsconsumer.quiz.BooleanAnswer;
import com.moe.metricsconsumer.quiz.CharStyle;
import com.moe.metricsconsumer.quiz.ManyOptionsAnswer;
import com.moe.metricsconsumer.quiz.NumberAnswer;
import com.moe.metricsconsumer.quiz.NumberRange;
import com.moe.metricsconsumer.quiz.Option;
import com.moe.metricsconsumer.quiz.OptionAnswer;
import com.moe.metricsconsumer.quiz.OptionsAnswer;
import com.moe.metricsconsumer.quiz.OptionsProposal;
...
import com.moe.metricsconsumer.quiz.SingleOptionsAnswer;
import com.moe.metricsconsumer.quiz.StringAnswer;
import com.moe.metricsconsumer.quiz.StyledString;
import com.moe.metricsconsumer.quiz.StyledStringQuestion;
import com.moe.metricsconsumer.quiz.util.QuizValidator;
...
public class QuizPackageImpl extends EPackageImpl implements QuizPackage {
	 ...
	 * @see com.moe.metricsconsumer.quiz.QuizPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEDataType(rgbEDataType, com.moe.metricsconsumer.exercise.util.RGB.class, "RGB", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
